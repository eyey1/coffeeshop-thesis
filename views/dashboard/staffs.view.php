...
<?php require "partials/nav.php"; ?>
    ...
    <div class="overlay" id="overlay">
        <div class="info-box">
            ...
            <form method="post" action="/admin_dashboard/staffs">
                ...
                <div class="form-group">
                    <label for="create_lastname">Email:</label>
                    <input type="email" class="form-control" name="email" id="create_lastname" required>
                </div>
                <div class="form-group">
    ...
    <div class="dashboard">
        <div class="top-right">
            <a href="#" class="login-button">Logout</a>
        </div>
        <div class="content">
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        <table id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $username = "if0_36400948";
                                $password = "5f48url9Y5HSfK";
