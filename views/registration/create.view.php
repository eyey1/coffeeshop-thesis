                          ...
                          <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                              ...
                              <form method="POST" action="/register" class="mb-5">
                                  <div class="form-group">
                                      <input name="firstname" type="text" class="form-control bg-transparent border-primary p-4" placeholder="First Name"
                                          required="required" />
                                  </div>
                                  ...
                                  <?php endif; ?>
                                  <div class="form-group">
                                      <input name="lastname" type="text" class="form-control bg-transparent border-primary p-4" placeholder="Last Name"
                                          required="required" />
                                  </div>
